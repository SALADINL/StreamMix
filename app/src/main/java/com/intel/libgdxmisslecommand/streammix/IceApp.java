...
import com.intel.libgdxmisslecommand.android.streammix.App.StreamPrx;
...
public class IceApp extends Application {
    ...
    public void onCreate()
    {
        ...
        //
        _lock = _wifiManager.createMulticastLock("Stream");
        _lock.acquire();
    ...
    void addMusic(String music)
    {
        try
        {
            ...
            _proxy.addMusicAsync(music).whenComplete((result, ex) ->
            {
                if(ex != null)
                {
                    _uiHandler.sendMessage(_uiHandler.obtainMessage(MSG_EXCEPTION, ex));
    ...
    void addMusicAsync(String music)
    {
        try
        {
            updateProxy();
            ...
            CompletableFuture<String> r = _proxy.addMusicAsync(music);
    ...
    void removeMusic()
    {
        try
        {
            ...
            _proxy.removeMusicAsync().whenComplete((result, ex) ->
            {
                if(ex != null)
                {
                    _uiHandler.sendMessage(_uiHandler.obtainMessage(MSG_EXCEPTION, ex));
    ...
    void removeMusicAsync()
    {
        try
        {
            ...
            final BooleanHolder response = new BooleanHolder();
            _uiHandler.sendMessage(_uiHandler.obtainMessage(MSG_SENDING));
            CompletableFuture<String> r = _proxy.removeMusicAsync();
            r.whenComplete((result, ex) ->
            {
                // There is no ordering guarantee between sent, response/exception.
                response.value = true;
    ...
    void playMusic()
    {
        try
        {
            ...
            _proxy.playMusicAsync().whenComplete((result, ex) ->
            {
                if(ex != null)
                {
                    _uiHandler.sendMessage(_uiHandler.obtainMessage(MSG_EXCEPTION, ex));
    ...
    void playMusicAsync()
    {
        try
        {
            ...
            final BooleanHolder response = new BooleanHolder();
            _uiHandler.sendMessage(_uiHandler.obtainMessage(MSG_SENDING));
            CompletableFuture<String> r = _proxy.playMusicAsync();
            r.whenComplete((result, ex) ->
            {
                // There is no ordering guarantee between sent, response/exception.
                response.value = true;
    ...
    void pauseMusic()
    {
        try
        {
            ...
            _proxy.pauseMusicAsync().whenComplete((result, ex) ->
            {
                if(ex != null)
                {
                    _uiHandler.sendMessage(_uiHandler.obtainMessage(MSG_EXCEPTION, ex));
    ...
    void pauseMusicAsync()
    {
        try
        {
            ...
            final BooleanHolder response = new BooleanHolder();
            _uiHandler.sendMessage(_uiHandler.obtainMessage(MSG_SENDING));
            CompletableFuture<String> r = _proxy.pauseMusicAsync();
            r.whenComplete((result, ex) ->
            {
                // There is no ordering guarantee between sent, response/exception.
                response.value = true;
    ...
    private void updateProxy()
    {
        ...
        {
            s = "ServerStream:tcp -h " + _host + " -p 12000";
        }
        System.out.println("coucou6 " +_mode.toString());
        ...
        _proxy = StreamPrx.uncheckedCast(prx);
    }
